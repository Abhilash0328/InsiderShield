        ...
        if critical_alerts_detail:
            ...
            for i, alert_data in enumerate(critical_alerts_detail[:10]):  # cap at 10 to avoid rate limits
                ...
                with st.expander(expander_label, expanded=(i == 0)):
                    ...
                    # AI analysis section
                    st.markdown('<div style="font-size:12px;font-weight:600;color:#60a5fa;margin:12px 0 8px;font-family:JetBrains Mono,monospace;border-left:3px solid #3b82f6;padding-left:8px">🤖 AI TRIAGE REPORT</div>', unsafe_allow_html=True)
